...
class Settings(BaseSettings):
    ...
    external_urls: dict = {
        ...
        "get_current_user": os.getenv("GET_CURRENT_USER",""),
        "get_task_url": os.getenv("GET_TASK_URL",""),
        "get_timesheets_by_task_id_url": os.getenv("GET_TIMESHEETS_BY_TASK_ID_URL",""),
        "get_timesheets_url": os.getenv("GET_TIMESHEETS_URL","")
    }
    ...
    admin_email: str = "WTP-ADMIN"
    app_name: str = os.getenv("APP_NAME", "WTP-payments HTTP API")
